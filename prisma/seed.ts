...
async function main() {
  ...
  const supplementProduct1 = await prisma.product.upsert({
    ...
    create: {
      ...
      orderUnit: 'pouch',
      subUnit: 'capsule',
      quantityOfSubUnitPerOrder: 270,
      unitsOfMeasurePerSubUnit: 'mg',
      ...
      formulationSummary: [
        "100% Magnesium Bisglycinate TRAACS® (Chelated)"
      ],
      leadTime: 6,
      capsuleInfo: [
        {
          ...
          "others": "A gentle daily dose for individuals with minor magnesium needs. Helps support relaxation, nervous system function, and sleep quality without excessive supplementation."
        },
        {
          "capsuleCount": 3,
          ...
          "others": "The recommended daily serving for most adults, promoting muscle relaxation, stress regulation, and energy metabolism. Chelated TRAACS® magnesium ensures high absorption and minimal digestive discomfort."
        },
        {
          "capsuleCount": 4,
          ...
          "others": "Ideal for athletes, individuals with muscle cramps, or those with high stress loads. This higher dose supports advanced recovery, cardiovascular function, and metabolic regulation."
        }
      ],
      productBenefits: [
        {
          benefit: "Highly Bioavailable & Gentle on Digestion",
          whyItMatters: "Magnesium Bisglycinate is fully chelated, ensuring superior absorption compared to other forms of magnesium while minimizing digestive discomfort."
        },
        {
          benefit: "Supports Muscle Relaxation & Recovery",
          whyItMatters: "Magnesium plays a key role in muscle contraction and relaxation, helping to prevent cramps, reduce muscle soreness, and support post-exercise recovery."
        },
        {
          benefit: "Promotes Restful Sleep & Stress Reduction",
          whyItMatters: "Magnesium Bisglycinate helps regulate neurotransmitters like GABA, promoting relaxation, reducing stress, and improving sleep quality."
        },
        {
          benefit: "Essential for Energy Production",
          whyItMatters: "Magnesium is a crucial cofactor in ATP production, the body's main energy source. It supports mitochondrial function and combats fatigue."
        },
        {
          benefit: "Supports Brain Function & Cognitive Health",
          whyItMatters: "Magnesium is involved in neurotransmitter function, helping with memory, focus, and neuroprotection against age-related cognitive decline."
        }
      ],
      healthCategories: [
        {
          category: "Sleep",
          whyItMatters: "Magnesium supports neurotransmitter function, promoting relaxation and improving sleep quality.",
          benefits: [
        ...
        {
          category: "Energy",
          whyItMatters: "Magnesium is involved in ATP production, providing sustained energy and reducing fatigue.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium is essential for cellular repair, reducing oxidative stress and supporting long-term health.",
          benefits: [
        ...
        {
          category: "Longevity",
          whyItMatters: "Optimal magnesium levels have been linked to increased lifespan and reduced risk of age-related diseases.",
          benefits: [
        ...
        {
          category: "Athletes",
          whyItMatters: "Magnesium plays a key role in muscle contraction, energy metabolism, and recovery.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium aids in protein synthesis, muscle function, and post-workout recovery.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium is vital for brain function, neurotransmitter balance, and preventing mental decline.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium helps regulate stress hormones and neurotransmitters linked to mood balance.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium contributes to bone density and joint flexibility, reducing the risk of stiffness and discomfort.",
          benefits: [
        ...
        {
          category: "Gut Health",
          whyItMatters: "Magnesium supports digestive enzyme function and smooth muscle movement in the intestines.",
          benefits: [
        ...
        },
        {
          ...
          whyItMatters: "Magnesium helps regulate heart rhythm, blood pressure, and vascular function.",
          benefits: [
    ...
    create: {
      ...
      capsuleInfo: [
        ...
        },
        {
          ...
          "others": "10g is a high-dose protocol for elite athletes and those in demanding training cycles. Increases creatine storage, optimizing muscle power, recovery, and cognitive resilience under high stress."
        }
      ],
      productBenefits: [
        {
          benefit: "Increases Strength & Power Output",
          whyItMatters: "Creatine enhances phosphocreatine stores in muscles, allowing for greater ATP production, which improves strength, power, and peak performance during high-intensity exercise."
        },
        {
          benefit: "Enhances Muscle Growth & Recovery",
          whyItMatters: "Creatine supports muscle cell hydration, protein synthesis, and growth, while also reducing muscle damage and accelerating post-exercise recovery."
        },
        {
          benefit: "Boosts Cognitive Function & Mental Clarity",
          whyItMatters: "Creatine plays a key role in brain energy metabolism, supporting cognitive function, memory, and mental clarity, particularly under stress or fatigue."
        },
        {
          benefit: "Improves Endurance & Reduces Fatigue",
          whyItMatters: "By optimizing ATP production, creatine delays muscle fatigue, enhances endurance, and supports prolonged high-intensity efforts."
        },
        {
          benefit: "Supports Healthy Aging & Cellular Energy",
          whyItMatters: "Creatine has been shown to support mitochondrial function, combat age-related muscle loss, and help maintain energy levels as you age."
        }
      ],
      healthCategories: [
        {
          category: "Athletes",
          whyItMatters: "Creatine is one of the most researched supplements for improving athletic performance, helping athletes push harder and recover faster.",
          benefits: [
        ...
        {
          category: "Weight Training",
          whyItMatters: "Creatine is essential for muscle strength, power, and growth, making it a staple for weightlifters and bodybuilders.",
          benefits: [
        ...
        {
          category: "Energy",
          whyItMatters: "Creatine replenishes ATP stores, the body's primary energy currency, leading to improved stamina and sustained performance.",
          benefits: [
        ...
        {
          category: "Healthy Aging",
          whyItMatters: "Creatine has been shown to help preserve muscle mass and strength as we age, reducing the risk of sarcopenia (age-related muscle loss).",
          benefits: [
        ...
        {
          category: "Longevity",
          whyItMatters: "By supporting mitochondrial efficiency and reducing oxidative stress, creatine has potential benefits for longevity and healthspan.",
          benefits: [
        ...
        {
          category: "Cognitive Function",
          whyItMatters: "Creatine provides energy to brain cells, improving mental clarity, reaction time, and focus, particularly in demanding cognitive tasks.",
          benefits: [
        ...
        {
          category: "Mood & Anxiety",
          whyItMatters: "Creatine has been linked to neurotransmitter support, helping with mood stability and mental resilience.",
          benefits: [
        ...
        {
          category: "Heart Health",
          whyItMatters: "Creatine helps regulate cellular energy in the heart, supporting cardiovascular function and recovery.",
          benefits: [
        ...
        {
          category: "Immunity",
          whyItMatters: "Creatine plays a role in immune system function by supporting cellular energy required for immune response and tissue repair.",
          benefits: [
        ...
        {
          category: "Joint Health",
          whyItMatters: "Creatine helps maintain muscle mass and strength, which is crucial for joint stability and long-term mobility.",
          benefits: [
